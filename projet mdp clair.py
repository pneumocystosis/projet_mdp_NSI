...
passComparisonOutputFont=tkFont.Font(family="Calibri",size=18,weight="bold")

#error and success labels, used in functions
error1Label=tk.Label(frame, text="\u2757 mot de passe doit contenir majuscules et minuscules", fg="red", font=errorFont, bg=BG)
...
#CheckButton
validateCheckvar=partial(validateCheck, mdp1, mdp2)
CheckButton=tk.Button(frame, text="Valider", command=validateCheckvar, cursor="hand2", bg=CheckBG, font=checkFont, fg="#fff")
